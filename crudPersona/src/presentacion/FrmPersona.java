...
public class FrmPersona extends javax.swing.JFrame {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtEdad, javax.swing.GroupLayout.DEFAULT_SIZE, 131, Short.MAX_VALUE))
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        String resp = personaControl.insertar(txtDni.getText(), txtNombre.getText(), txtApellido.getText(), txtTelefono.getText(), Integer.parseInt(txtEdad.getText()));
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        if (txtDni.getText().isEmpty()) {
            ...
            persona = personaControl.buscar(txtDni.getText());
            if (persona == null) {
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        persona = new Persona(Integer.parseInt(txtIdPersona.getText()), txtDni.getText(), txtNombre.getText(), txtApellido.getText(), txtTelefono.getText(), Integer.parseInt(txtEdad.getText()));
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        if (txtDni.getText().isEmpty()) {
            ...
            if (personaControl.buscar(txtDni.getText()) == null) {
                JOptionPane.showMessageDialog(this, "No existe la persona con el dni: " + txtDni.getText());
            }else{
                String resp = personaControl.eliminar(txtDni.getText());
                if (resp.equalsIgnoreCase("ok")) {
